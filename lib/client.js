window.__ModuleLoader__.load({
	...
	factory: (require) => {
		...
		const CARD_CSS = [
			...
			".dsh-n_switch input:checked+.dsh-n_switchTrack{background:var(--dsw-alias-state-success-primary)}",
			...
			".dsh-n_slider{flex:1;height:6px;-webkit-appearance:none;appearance:none;border-radius:3px;background:var(--dsw-alias-fill-l2);outline:none}",
			".dsh-n_slider::-webkit-slider-thumb{-webkit-appearance:none;width:16px;height:16px;border-radius:50%;background:var(--dsw-alias-state-success-primary);cursor:pointer;box-shadow:0 1px 2px rgba(0,0,0,.2)}",
			".dsh-n_slider::-moz-range-thumb{width:16px;height:16px;border:none;border-radius:50%;background:var(--dsw-alias-state-success-primary);cursor:pointer}",

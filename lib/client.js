window.__ModuleLoader__.load({
	...
	factory: (require) => {
		...
		const CARD_CSS = [
			".dsh-n_card{box-sizing:border-box;border:1px solid var(--dsw-alias-border-l1);border-radius:12px;background:var(--dsw-alias-bg-base);overflow:hidden}",
			".dsh-n_header{display:flex;align-items:center;gap:8px;padding:12px 14px;cursor:pointer;user-select:none;background:0 0;border:0;width:100%;text-align:left;font:inherit}",
			".dsh-n_headText{flex:1;display:flex;flex-direction:column;gap:2px;min-width:0}",
			".dsh-n_name{font-size:14px;font-weight:600;color:var(--dsw-alias-label-primary)}",
			".dsh-n_desc{font-size:12px;color:var(--dsw-alias-label-tertiary)}",
			...
			".dsh-n_row{display:flex;align-items:center;gap:8px;padding:8px 0;border-bottom:1px solid var(--dsw-alias-border-l2)}",
			".dsh-n_row:last-child{border-bottom:none}",
			".dsh-n_label{flex:1;font-size:13px;color:var(--dsw-alias-label-primary)}",
		...
		function injectCardStyles() {
			...
			if (document.querySelector && !document.querySelector("style[data-plugin-css=" + JSON.stringify(tagId) + "]")) {
			...
			return react_jsx_runtime.jsxs("li", { style: { listStyle: "none" }, children: [
				react_jsx_runtime.jsxs("div", { className: "dsh-n_card", children: [
					react_jsx_runtime.jsxs("button", {
						...
						"aria-expanded": open,
						"aria-label": (open ? "收起设置" : "展开设置") + "：回答完成提醒",
						onClick: () => setOpen(!open),
						children: [
							react_jsx_runtime.jsxs("div", { className: "dsh-n_headText", children: [
								react_jsx_runtime.jsx("span", { className: "dsh-n_name", children: "回答完成提醒" }),
								react_jsx_runtime.jsx("span", { className: "dsh-n_desc", children: "DSH 回答结束或 agent 提问时：提示音 + 系统通知" })
							] }),
					...
					open && react_jsx_runtime.jsxs("div", { className: "dsh-n_body", children: [
						...
						react_jsx_runtime.jsxs("label", { className: "dsh-n_row", children: [
							...
							react_jsx_runtime.jsx("input", { type: "checkbox", checked: !!cv.enabled, disabled: !writable, onChange: (e) => onToggle("enabled", e.target.checked) })
						] }),
						react_jsx_runtime.jsxs("label", { className: "dsh-n_row", children: [
							react_jsx_runtime.jsx("span", { className: "dsh-n_label", children: "提示音" }),
							react_jsx_runtime.jsx("input", { type: "checkbox", checked: !!cv.sound, disabled: !writable || !cv.enabled, onChange: (e) => onToggle("sound", e.target.checked) })
						] }),
						react_jsx_runtime.jsxs("label", { className: "dsh-n_row", children: [
							react_jsx_runtime.jsx("span", { className: "dsh-n_label", children: "系统通知" }),
							react_jsx_runtime.jsx("input", { type: "checkbox", checked: !!cv.notify, disabled: !writable || !cv.enabled, onChange: (e) => onToggle("notify", e.target.checked) })
						] }),
						react_jsx_runtime.jsxs("label", { className: "dsh-n_row", children: [
							react_jsx_runtime.jsx("span", { className: "dsh-n_label", children: "出错 / 中止也提醒" }),
							react_jsx_runtime.jsx("input", { type: "checkbox", checked: !!cv.notifyOnError, disabled: !writable || !cv.enabled, onChange: (e) => onToggle("notifyOnError", e.target.checked) })
						] }),
						react_jsx_runtime.jsxs("label", { className: "dsh-n_row", children: [
							react_jsx_runtime.jsx("span", { className: "dsh-n_label", children: "提问时也提醒" }),
							react_jsx_runtime.jsx("input", { type: "checkbox", checked: !!cv.notifyOnQuestion, disabled: !writable || !cv.enabled, onChange: (e) => onToggle("notifyOnQuestion", e.target.checked) })
						] }),
						react_jsx_runtime.jsxs("label", { className: "dsh-n_row", children: [
							react_jsx_runtime.jsx("span", { className: "dsh-n_label", children: "音量" }),
							react_jsx_runtime.jsx("input", { type: "range", min: 0, max: 1, step: 0.05, value: cv.volume, disabled: !writable || !cv.enabled, style: { flex: 1 }, onChange: (e) => onToggle("volume", Number(e.target.value)) }),
